...
- Record audio in the browser (including selecting a specific microphone before recording)
...
- Play back or delete the original audio file, including playback speed control
